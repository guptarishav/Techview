...
const Navbar =()=>{
  ...
  <div className="container-fluid">
    <NavLink  exact className="navbar-brand" to="/" id="title">Techview</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink exact  activeClassName='menu_active' className="nav-link" to="/contact"s>Contact Us</NavLink>
        </li>
